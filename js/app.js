    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new core(".main-offers__slider", {
                ...
                lazy: true,
                pagination: {
                    el: ".main-offers__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".main-offers__swiper-button-prev",
                    nextEl: ".main-offers__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            new core(".events-offers__slider", {
                ...
                lazy: true,
                pagination: {
                    el: ".events-offers__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".events-offers__swiper-button-prev",
                    nextEl: ".events-offers__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            new core(".gallery-events__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 0,
                ...
                lazy: true,
                pagination: {
                    el: ".gallery-events__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".gallery-events__swiper-button-prev",
                    nextEl: ".gallery-events__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            new core(".gallery-hotel__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 0,
                ...
                lazy: true,
                pagination: {
                    el: ".gallery-hotel__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".gallery-hotel__swiper-button-prev",
                    nextEl: ".gallery-hotel__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            new core(".standart-offers__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
                ...
                lazy: true,
                pagination: {
                    el: ".standart-offers__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".standart-offers__swiper-button-prev",
                    nextEl: ".standart-offers__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
